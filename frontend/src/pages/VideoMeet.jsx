...
import "../style/videoComponentModule.css";
...
import server from '../environment.js'; // Import the server URL from environment.js
        ...
        <div>
            {askForUsername ? (
                ...
                <div className="meetVideoContainer">
                    ...
                    <video className="meetUserVideo" ref={localVideoref} autoPlay muted playsInline></video>
